...
public class Player extends Base {
    ...
    public void loadImagem() {
        try {
            for (int i = 0; i < 10; i++) {
                getImages().add(ImageIO.read(getClass().getResourceAsStream("/imagens/Player/Correndo/" + i + ".png")).getScaledInstance(getW() * 2, getH(), Image.SCALE_DEFAULT));
                pulo.add(ImageIO.read(getClass().getResourceAsStream("/imagens/Player/Pulando/" + i + ".png")).getScaledInstance(getW() * 2, getH(), Image.SCALE_DEFAULT));
                deslize.add(ImageIO.read(getClass().getResourceAsStream("/imagens/Player/Rolando/" + i + ".png")).getScaledInstance(getW() * 2, getH(), Image.SCALE_DEFAULT));
            }
